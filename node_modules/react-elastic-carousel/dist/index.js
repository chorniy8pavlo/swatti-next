...
var Track = function Track(_ref) {
  ...
  var originalChildren = React.Children.map(children, function (child, idx) {
    ...
    var isVisible = idx >= min && idx < max; // we can't fix the typo (swipable -> swipeable) without a major bump

    var swipeableClassName = cssPrefix("swipable", "swipable-".concat(idx));
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: cssPrefix("carousel-item", "carousel-item-".concat(idx)),
...
var Carousel = /*#__PURE__*/function (_React$Component) {
  ...
  function Carousel() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getCalculatedItemsToShow", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateSliderPosition", function () {
      _this.setState(function (state, props) {
        ...
        var numOfVisibleItems = _this.getCalculatedItemsToShow();
    ...
    _defineProperty(_assertThisInitialized(_this), "onContainerResize", function (sliderContainerNode) {
      ...
      _this.setState({
        ...
        */
        var visibleItems = _this.getCalculatedItemsToShow();
    ...
    _defineProperty(_assertThisInitialized(_this), "goTo", function (nextItemId) {
      ...
      var itemsToshow = _this.getCalculatedItemsToShow();
